...
// import java.util.List;
// import java.util.Optional;
// >>>>>>> 0e415649c3133b95ac776b44373667c3668830f8
...
//     @GetMapping(value = "/listar/ong/{ongId}")
...
//             Optional<Campanha> campanhas = campanhaRepository.findCampanhasByOngId(ong_id);
//             System.out.println("📊 Campanhas encontradas: " + campanhas.size());
